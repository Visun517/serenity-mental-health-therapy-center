...
public interface TheraphistsBo extends SuperBo {
     ...
     boolean saveTherapist(TherapistDto therapistDto ,List<String> programNames) throws SQLException, MissingFieldException, DuplicateException;
     boolean delete(String id) throws SQLException;
     boolean update(TherapistDto therapistDto ,List<String> programNames) throws SQLException, MissingFieldException, DuplicateException;
